%% Set sqrtN^2 (i.e. N) sensor locs for square grid (CASE 1)
sqrtN = 3;
...
%% Set 2*sqrtN^2 (i.e. 2N) sensor locs for fork (CASE 2)
sqrtN = 10;
...
save(strcat("Case2/meshes_sensors/sensor_locs_",num2str(2*sqrtN^2),".mat"),"sensor_locs")


%% Set n_per_turn*n_radii sensor locs for annulus (CASE 3)
n_per_turn = 6;
n_radii = 4;
...
sensor_locs = [sensor_locs_x' sensor_locs_y'];
save(strcat("Case3/meshes_sensors/sensor_locs_",num2str(n_per_turn*n_radii),".mat"),"sensor_locs")